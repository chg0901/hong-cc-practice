...
| `BAIDU_API_KEY` | 60 位 | `bc(还有五十八位)` | `.env` / skill config.json |
...
- [2026-04-20 13:27:59] 新增 BAIDU_API_KEY 到已知敏感信息清单
- [2026-04-07 — Initial: 密码脱敏规范、变量替换模式、.env.example 维护、安全审计清单](changes/2026-04-07)
